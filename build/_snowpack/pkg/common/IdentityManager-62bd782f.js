import { e, y, i as i$2, W as s$3, bS as n, a as a$2, m as n$1, bX as s$4, b_ as $, U, V as a$3, b$ as z, a8 as v, s as s$5, ad as b$1, bl as E, C as U$1, c0 as b$2, aA as r, aR as z$1, c1 as A, aH as T, bU as C$1, c2 as n$2 } from './Identifiable-c8406192.js';
import { p as p$4, e as e$3, s as s$6, t as t$1 } from './config-b3bf08ce.js';
import { e as e$1, L, o as o$1, p as p$3 } from './Widget-2f53b352.js';
import { e as e$2 } from './widget-0e54f9c7.js';
...
*/
const l$1={base:"esri-identity-form",group:"esri-identity-form__group",label:"esri-identity-form__label",footer:"esri-identity-form__footer",esriInput:"esri-input",esriButton:"esri-button",esriButtonSecondary:"esri-button--secondary"},p$2="ArcGIS Online";let a$1=class extends L{constructor(s,e){super(s,e),this._usernameInputNode=null,this._passwordInputNode=null,this.messages=null,this.signingIn=!1,this.server=null,this.resource=null,this.error=null,this.oAuthPrompt=!1;}render(){const{error:s,server:e,resource:t,signingIn:i,oAuthPrompt:u,messages:a}=this,d=o$1("div",{class:l$1.group},s$3(u?a.oAuthInfo:a.info,{server:/\.arcgis\.com/i.test(e)?p$2:e,resource:`(${t||a.lblItem})`})),c=u?null:o$1("div",{class:l$1.group},o$1("label",{class:l$1.label},a.lblUser,o$1("input",{value:"",required:!0,autocomplete:"off",spellcheck:!1,type:"text",bind:this,afterCreate:p$3,"data-node-ref":"_usernameInputNode",class:l$1.esriInput}))),m=u?null:o$1("div",{class:l$1.group},o$1("label",{class:l$1.label},a.lblPwd,o$1("input",{value:"",required:!0,type:"password",bind:this,afterCreate:p$3,"data-node-ref":"_passwordInputNode",class:l$1.esriInput}))),h=o$1("div",{class:this.classes(l$1.group,l$1.footer)},o$1("input",{type:"submit",disabled:!!i,value:i?a.lblSigning:a.lblOk,class:l$1.esriButton}),o$1("input",{type:"button",value:a.lblCancel,bind:this,onclick:this._cancel,class:this.classes(l$1.esriButton,l$1.esriButtonSecondary)})),b=s?o$1("div",null,s.details&&s.details.httpStatus?a.invalidUser:a.noAuthService):null;return o$1("form",{class:l$1.base,bind:this,onsubmit:this._submit},d,b,c,m,h)}_cancel(){this._set("signingIn",!1),this._usernameInputNode&&(this._usernameInputNode.value=""),this._passwordInputNode&&(this._passwordInputNode.value=""),this.emit("cancel");}_submit(s){s.preventDefault(),this._set("signingIn",!0);const e=this.oAuthPrompt?{}:{username:this._usernameInputNode&&this._usernameInputNode.value,password:this._passwordInputNode&&this._passwordInputNode.value};this.emit("submit",e);}};e([y(),e$1("esri/identity/t9n/identity")],a$1.prototype,"messages",void 0),e([y()],a$1.prototype,"signingIn",void 0),e([y()],a$1.prototype,"server",void 0),e([y()],a$1.prototype,"resource",void 0),e([y()],a$1.prototype,"error",void 0),e([y()],a$1.prototype,"oAuthPrompt",void 0),a$1=e([i$2("esri.identity.IdentityForm")],a$1);var d$1=a$1;
...
See https://js.arcgis.com/4.19/esri/copyright.txt for details.
*/
const l={base:"esri-identity-modal",open:"esri-identity-modal--open",closed:"esri-identity-modal--closed",title:"esri-identity-modal__title",dialog:"esri-identity-modal__dialog",content:"esri-identity-modal__content",closeButton:"esri-identity-modal__close-button",iconClose:"esri-icon-close"};let d=class extends L{constructor(t,e){super(t,e),this.container=document.createElement("div"),this.content=null,this.open=!1,this._close=()=>{this.open=!1;},document.body.appendChild(this.container),this.own(this.watch("open",(()=>this._toggleFocusTrap())));}destroy(){this._destroyFocusTrap();}render(){const t=this.id,{open:e,content:o,title:s,messages:i}=this,n=e&&!!o,a={[l.open]:n,[l.closed]:!n},c=o$1("button",{class:l.closeButton,"aria-label":i.close,title:i.close,bind:this,onclick:this._close},o$1("span",{"aria-hidden":"true",class:l.iconClose})),d=`${t}_title`,p=`${t}_content`,u=s?o$1("h1",{id:d,class:l.title},s):null,m=n?o$1("div",{bind:this,class:l.dialog,role:"dialog","aria-labelledby":d,"aria-describedby":p,afterCreate:this._createFocusTrap},c,u,this._renderContent(p)):null;return o$1("div",{tabIndex:-1,class:this.classes(l.base,a)},m)}_destroyFocusTrap(){var t;null==(t=this._focusTrap)||t.deactivate({onDeactivate:null}),this._focusTrap=null;}_toggleFocusTrap(){const{_focusTrap:t,open:e}=this;t&&(e?t.activate():t.deactivate());}_createFocusTrap(t){this._destroyFocusTrap();const o=requestAnimationFrame((()=>{this._focusTrap=createFocusTrap(t,{initialFocus:"input",onDeactivate:this._close}),this._toggleFocusTrap();}));this.own(n((()=>cancelAnimationFrame(o))));}_renderContent(t){const e=this.content;return "string"==typeof e?o$1("div",{class:l.content,id:t,innerHTML:e}):e$2(e)?o$1("div",{class:l.content,id:t},e.render()):e instanceof HTMLElement?o$1("div",{class:l.content,id:t,bind:e,afterCreate:this._attachToNode}):null}_attachToNode(t){const e=this;t.appendChild(e);}};e([y({readOnly:!0})],d.prototype,"container",void 0),e([y()],d.prototype,"content",void 0),e([y()],d.prototype,"open",void 0),e([y(),e$1("esri/t9n/common")],d.prototype,"messages",void 0),e([y({aliasOf:"messages.auth.signIn"})],d.prototype,"title",void 0),d=e([i$2("esri.identity.IdentityModal")],d);var p$1=d;
